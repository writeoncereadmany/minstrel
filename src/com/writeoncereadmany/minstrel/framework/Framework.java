...
public class Framework 
{
	...
	{
		final ASTBuildingParseListener builder = new ASTBuildingParseListener();
	...
	{
		Context defaultContext = new DefaultSystemContext();
		execute(programText, defaultContext);
	}
	
	public void execute(final String programText, final Context customContext)
	{
